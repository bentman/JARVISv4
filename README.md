...
[![Status: Active-Reference](https://img.shields.io/badge/status-Active-Reference-yellow)](#)
...
See [Project.md](Project.md) for the authoritative architecture and vision.
...
## Credits
This work builds upon the foundations laid by [JARVISv2](https://github.com/bentman/JARVISv2) and [JARVISv3](https://github.com/bentman/JARVISv3).
